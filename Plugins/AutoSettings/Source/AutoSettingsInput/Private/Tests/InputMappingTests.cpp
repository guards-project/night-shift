 ...
 */
IMPLEMENT_SIMPLE_AUTOMATION_TEST(FPreservedActionsTest, "AutoSettings.Input.PreservedActions", EAutomationTestFlags::ApplicationContextMask | EAutomationTestFlags::SmokeFilter)
