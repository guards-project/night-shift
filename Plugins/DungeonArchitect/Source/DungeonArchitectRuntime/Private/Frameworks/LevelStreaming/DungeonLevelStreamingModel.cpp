...
UDungeonLevelStreaming* FLevelStreamLoader::LoadLevelInstanceBySoftObjectPtr(
...
UDungeonLevelStreaming* FLevelStreamLoader::LoadLevelInstance_Internal(UWorld* World, const FString& LongPackageName,
    ...
    UDungeonLevelStreaming* StreamingLevel = NewObject<UDungeonLevelStreaming>(
        World, UDungeonLevelStreaming::StaticClass(), NAME_None, RF_Transient | RF_DuplicateTransient, nullptr);
...
void UDungeonStreamingChunk::CreateLevelStreaming(UObject* WorldContextObject, TSoftObjectPtr<UWorld> Level,
                                                  uint32 InstanceId, const FTransform& Transform,
                                                  bool& bOutSuccess) {
    LevelStreaming = FLevelStreamLoader::LoadLevelInstanceBySoftObjectPtr(
        WorldContextObject, Level, InstanceId, Transform, bOutSuccess, LevelPackage);
