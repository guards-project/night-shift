...
/////////////////////// Node: MarkerListExists ///////////////////////
const FName UMGPatternScriptNode_MarkerListExists::OutPinID_Default = "DefaultOutput";
void UMGPatternScriptNode_MarkerListExists::AllocateDefaultPins() {
	AddOutputPin<UMGPatternScriptNodePinBool>(OutPinID_Default);
}

FText UMGPatternScriptNode_MarkerListExists::GetNodeTitle() const {
	static const FText NodeTitle = LOCTEXT("NodeTitle_MarkerListExists", "Marker List Exists");
	return NodeTitle;
}
