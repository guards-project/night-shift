...
TArray<UFlowAbstractLink*> UFlowAbstractGraphBase::GetOutgoingLinkObjects(const FGuid& NodeId) {
    TArray<UFlowAbstractLink*> Result;
    for (UFlowAbstractLink* Link : GraphLinks) {
        if (Link->Source == NodeId) {
            Result.Add(Link);
...
TArray<UFlowAbstractLink*> UFlowAbstractGraphBase::GetIncomingLinkObjects(const FGuid& NodeId) {
    TArray<UFlowAbstractLink*> Result;
    for (UFlowAbstractLink* Link : GraphLinks) {
        if (Link->Destination == NodeId) {
            Result.Add(Link);
