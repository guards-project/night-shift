...
private:
    static void ExecuteSpawnLogics(AActor* SpawnedActor, ADungeon* InDungeon, const FRandomStream& InRandom, const TArray<UDungeonSpawnLogic*>& SpawnLogics);
...
class DUNGEONARCHITECTRUNTIME_API SceneProviderCommand_CreateMeshSimple : public FSceneProviderCommand {
public:
    SceneProviderCommand_CreateMeshSimple(ADungeon* InDungeon, ULevel* InLevelOverride, const FDungeonSceneProviderContext& InContext, UStaticMesh* InMesh)
        : FSceneProviderCommand(InDungeon, InLevelOverride, InContext), Mesh(InMesh) {
    }
...
class DUNGEONARCHITECTRUNTIME_API SceneProviderCommand_ReuseStaticMeshSimple : public SceneProviderCommand_ReuseActor {
public:
    SceneProviderCommand_ReuseStaticMeshSimple(ADungeon* InDungeon, const FDungeonSceneProviderContext& InContext,
                                         AActor* InActorToReuse, UStaticMesh* InMesh)
        : SceneProviderCommand_ReuseActor(InDungeon, InContext, InActorToReuse)
          , Mesh(InMesh) {
    }
