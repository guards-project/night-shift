...
public:
    ...
    void OnItemSpawn(AActor* Actor, ADungeon* Dungeon, const FRandomStream& RandomStream);

    virtual void OnItemSpawn_Implementation(AActor* Actor, ADungeon* Dungeon, const FRandomStream& RandomStream);
