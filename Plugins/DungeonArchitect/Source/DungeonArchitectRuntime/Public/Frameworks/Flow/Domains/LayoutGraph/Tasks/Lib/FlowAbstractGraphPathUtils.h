...
public:
    ...
    static void GetNodeCoords(const FFlowAbstractGraphQuery& GraphQuery, const TArray<FGuid>& GroupNodes, TSet<FVector>& OutCoords);
    static void GetNodeCoords(const UFlowAbstractNode* InNode, TSet<FVector>& OutCoords);
};
