...
public:
    ...
    TArray<FName> GetCategoriesAtNode(int32 PathIndex, int32 PathLength, const TArray<FVector>& NodeCoords) const;
...
public:
    ...
    bool TryOverrideCategories(int32 PathIndex, int32 PathLength, const TArray<FName>& ExistingCategories, const TArray<FVector>& NodeCoords, TArray<FName>& OutNewCategories);
    virtual bool TryOverrideCategories_Implementation(int32 PathIndex, int32 PathLength, const TArray<FName>& ExistingCategories, const TArray<FVector>& NodeCoords, TArray<FName>& OutNewCategories) { return false; }
};
