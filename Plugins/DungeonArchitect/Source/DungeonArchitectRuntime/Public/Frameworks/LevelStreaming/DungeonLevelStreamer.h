...
struct DUNGEONARCHITECTRUNTIME_API FDungeonLevelStreamingConfig {
     ...
     */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Dungeon Streaming", Meta=(EditCondition = "bEnabledLevelStreaming && StreamingStrategy == EDungeonLevelStreamingStrategy::LayoutDepth"))
    ...
    *  This requires the Streaming Strategy to be set to LayoutDepth
    */
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Dungeon Streaming", Meta=(EditCondition = "bEnabledLevelStreaming && StreamingStrategy == EDungeonLevelStreamingStrategy::Distance"))
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Dungeon Streaming", Meta = (EditCondition = "bEnabledLevelStreaming"))
    EDungeonLevelStreamUnloadMethod UnloadMethod = EDungeonLevelStreamUnloadMethod::KeepHiddenChunksInMemory;
...
public:
    ...
    virtual void GetVisibleChunks(UDungeonStreamingChunk* StartChunk, const TArray<UDungeonStreamingChunk*>& AllChunks, TArray<UDungeonStreamingChunk*>& OutVisibleChunks) const = 0;
};
...
private:
    static void GetVisibleChunks(const FDungeonLevelStreamingConfig& Config, UDungeonStreamingChunk* StartChunk, const TArray<UDungeonStreamingChunk*>& AllChunks,
