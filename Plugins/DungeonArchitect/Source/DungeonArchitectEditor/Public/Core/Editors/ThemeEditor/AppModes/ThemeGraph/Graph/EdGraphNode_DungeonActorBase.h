...
public:
    ...
    virtual TArray<UObject*> GetThumbnailAssetObjects();
...
public:
    ...
    */
    UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Category = "Selection Logic", meta=(EditCondition="bUseSelectionLogic"))
    ...
    */
    ...
    UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Instanced, SimpleDisplay, Category = "Transform Logic", meta=(EditCondition="bUseTransformLogic"))
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Instanced, SimpleDisplay, Category = "Transform Logic", meta=(EditCondition="bUseProceduralTransformLogic"))
    ...
    /** Create a blueprint to decide on the transform offset that needs to be applied on this node */
    UPROPERTY(EditDefaultsOnly, BlueprintReadWrite, Instanced, SimpleDisplay, Category = "Spawn Logic", meta=(EditCondition="bUseSpawnLogic"))
