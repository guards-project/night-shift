...
UMGPatternGraphNode_MarkerListExists::UMGPatternGraphNode_MarkerListExists(const FObjectInitializer& ObjectInitializer) : Super(ObjectInitializer) {
	NodeTemplate = ObjectInitializer.CreateDefaultSubobject<UMGPatternScriptNode_MarkerListExists>(this, "Template");
}

void UMGPatternGraphNode_MarkerListExists::AllocateDefaultPins() {
	CreatePin(EGPD_Output, FMGPatternPinCategory::Bool, "");
}
