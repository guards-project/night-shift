...
#include "Core/Editors/ThemeEditor/AppModes/ThemeGraph/Graph/DungeonPropConnectionDrawingPolicy.h"
...
#include "Core/Editors/ThemeEditor/AppModes/ThemeGraph/Graph/EdGraphSchema_Extensions.h"
...
void UEdGraphSchema_DungeonProp::GetActionList(TArray<TSharedPtr<FEdGraphSchemaAction>>& OutActions,
    ...
    if (bShowNewMesh) {
        ...
        FDungeonSchemaUtils::AddAction<UEdGraphNode_DungeonMeshList>(
